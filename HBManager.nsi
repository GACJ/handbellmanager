...
Section "Handbell Manager"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\HandbellManager" "Publisher" "Graham A C John"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\HandbellManager" "RegCompany" "Graham A C John"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\HandbellManager" "RegOwner" "Graham A C John"
