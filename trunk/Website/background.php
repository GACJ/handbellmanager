...
This is impracticable. The alternative, and one that many handbell
...
rest. Some ringers seem to manage this quite successfully, but it
...
but it is no substitute for swinging ones arms up and down.</li>
...
<li>Abel does not hold up if you ring late. Real ringers will often
use gestures to help you strike your bell before or after them,
introducing a slight stretching of the row if you ring late.</li> 
</ol>
<div align=center>
<p<img src="img/Abel.png" alt="Abel Simulator" width="555" height="450" hspace="15"></p></p>
<p class="caption"><a target="_top"
href="http://www.abelsim.co.uk">Abel Simulator</a></p>
</div>
...
<div align=center>
<p><img src="img/actionxlwiredcontroller.png" alt="ActionXL wired motion controller" width=
"150" height="240" hspace="15"></p>
<p class="caption"><a target="_top"
href="http://www.actionxl.com">ActionXL Motion Controller</a></p>
</div>
...
controllers to simulate rackets etc. At least one of these Wii games
uses its controllers in a shaking action to simulate ringing handbells
to tunes, as is evidenced by this YouTube video of tune ringing on the Nintendo Wii. 
...
company makes both wired and a wireless motion controller for PCs,
